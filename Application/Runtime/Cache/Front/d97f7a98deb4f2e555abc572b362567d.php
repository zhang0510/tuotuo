...
<div class="part1" style="width: 100%">
	...
	<div class="deng0">
	   <div class="deng2">
			<div class="deng2a">
			<p><a class="ww1 on" href="javascript:void(0);">普通登录方式</a><a class="ww2" href="/Front/Login/mobilelogin">手机动态码登录</a></p>
			</div>
			<div class="deng2b">
			<div class="deng2b1">
						...
						if(VCode!=""){
							$.post('/Front/Login/verifyCode',{'VCode':VCode},function(data_VCode){
								if(data_VCode==0){
									...
									//提交
									$.post('/Front/Login/pc_Login_Verify',{'tel':tel,'user_pwd':user_pwd,'VCode':VCode},function(data){
										if(data.type==0){
											$.anewAlert(data.info);
										}else{
