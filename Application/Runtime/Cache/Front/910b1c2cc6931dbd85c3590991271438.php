...
<script type="text/javascript">
	function groupOrder(){
		...
		window.location.href="/Front/GroupBuy/groupOrder/payway/"+payway+"/token/"+token;
	}
	function payway(obj){
...
<div class="order_main container">
  <div class="order_detail">
    <div class="order_d1">
	  <div class="du32">
	  <!--  <p>积分抵扣：￥0元</p> -->
	   <p>奖券抵扣：￥<?php echo ((isset($youhui) && ($youhui !== ""))?($youhui):"0"); ?>元</p>
	   <p>运输价格（含提车费）：￥<?php echo ((isset($yuanjia) && ($yuanjia !== ""))?($yuanjia):"0"); ?>元</p>
	   <p>保险费用：￥<?php echo ((isset($baoxian) && ($baoxian !== ""))?($baoxian):"0"); ?>元</p>
	   <p>优  惠  券：￥<?php echo ((isset($youhui) && ($youhui !== ""))?($youhui):"0"); ?>元</p>
	   <p>团购优惠：￥<?php echo ((isset($tuangouyouhui) && ($tuangouyouhui !== ""))?($tuangouyouhui):"0"); ?>元</p>
	   <p>送车价格：￥<?php echo ((isset($songcheshangmen) && ($songcheshangmen !== ""))?($songcheshangmen):"0"); ?>元</p>
	  <p class="on">共计：<span><b>￥<em><?php echo ((isset($platelets) && ($platelets !== ""))?($platelets):"0"); ?></em>元</b></span></p>
	  </div>
	  <div class="du339">
	    <div class="du339a">
	   <ul>
	     <li class="on">
		 <label onclick="payway(this);">
		 	<img src="/Public/Front/images/zf1.png">
		 	<p>支付宝</p>
		 	<input value="Z" type="radio" name="pay">
		 <label>
		 </li>
		 <!--
		   <li>
		 <label onclick="payway(this);"><img src="/Public/Front/images/zf2.png">
		 <p>微信</p>
		 <input value="W" type="radio" name="pay">
		 <label>
		 </li>-->
		   <li>
		 <label onclick="payway(this);"><img src="/Public/Front/images/zf3.png">
		 <p>货到付款</p>
	 ...
	 <div class="du339b">
	  <input type="hidden" name="payWay" id="payWay_ID" value="Z"/>
	  <input type="hidden" name="token_code" id="token_code" value="<?php echo ($token); ?>"/>
	  <button type="button" onclick="groupOrder();">确定付款</button>
