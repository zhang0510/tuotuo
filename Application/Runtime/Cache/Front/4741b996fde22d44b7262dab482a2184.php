...
<!--banner-->
	<div class="banner">
		<div class="bannerdiv">
			<div class="serchimg">
				<div class="tiaofun"  onclick="ddxs()">
			...
			<div class="ksfw">
				<table id="searchtable" class="pc fwtable1">
					...
					<tr class="searchtd">
						<td>
							<div class="xddiv">
								<div class="xdchild"  onclick="tiaoFun();">
...
<div class="part8">
	  <div style="width:50%;float:left;">
		  ...
		  <div class="gsjsfont">
			  ...
			  <div class="xddiv xddivxg">
				  <div class="xdchild">
					  <center><font class="xddfont"><a>详情</a></font></center>
				  </div>
			  </div>
		  </div>
	  </div>
	  <div style="width:50%;float:right;">
		  ...
		  <div class="fwbzfont">
			  ...
			  <div class="xddiv xddivxg">
				  <div class="xdchild">
					  <center><font class="xddfont"><a>更多</a></font></center>
				  </div>
			  </div>
		  </div>
	  </div>
				...
				<table class="xwtable">
					<tr>
						<td class="xdtd1">
							...
							<div class="xddiv2">
								<font>2018-01-26 14:03:04</font>
							</div>
							<div class="xddiv3">
								<font>妥妥运车业务的进展速度很快。“妥妥运车”是</font>
							</div>
							<div class="xddiv4">
								<div class="more">
									<div class="morechild">
										<center><font class="morefont"><a>MORE</a></font></center>
									</div>
								</div>
							</div>
						</td>
...
<script>
	...
	function ddxs(){
		$(".xiadan").attr("style","background:url(/Public/Front/images/xiadanf.png)");
		$(".serchimg").attr("style","background:url(/Public/Front/images/dingdanchaxunb.png)");
	    $("#searchtable").show();
	    $("#xdtable").hide();
    ...
    function xdxs(){
        $(".xiadan").attr("style","background:url(/Public/Front/images/xiadanb.png)");
        $(".serchimg").attr("style","background:url(/Public/Front/images/dingdanchaxun.png)");
        $("#searchtable").hide();
        $("#xdtable").show();
