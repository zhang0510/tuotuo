...
<div class="order_body1">
	<div class="order_main container">
		...
		<div class="order_navc">
			<ul>
				<li class="on">车钥匙：<?php echo ($ret["verify_car_keys"]); ?>(单位:把)</li>
				<li>车辆当前公里数：<?php echo ($ret["verify_km"]); ?>(单位:km)</li>
				<li>提车预计行驶公里数：<?php echo ($ret["verify_km"]); ?>(单位:km)</li>
			</ul>
		</div>
		<div class="dengm2">
			<div class="deng0">
				<div class="deng2e">
					<div class="rr5h">
						<dl><dt>行李工具备注：</dt><dd><p><?php echo ($ret["verify_xingli"]); ?></p><dd></dl>
					</div>
					<div class="rr5h">
						<dl><dt>车身外观：</dt><dd><p><?php echo ($ret["verify_car_wai"]); ?></p><dd></dl>
					</div>
					<div class="yyu1">
						<div class="order_h2"><h2>拍照验车</h2></div>
						<ul>
							<?php if(is_array($ret["imgs"])): foreach($ret["imgs"] as $key=>$vo): ?><li>
									<div class="xxz4"><img  style="height:200px;"  src="<?php echo ($vo["verify_img_upload"]); ?>"/></div>
								</li><?php endforeach; endif; ?>
						</ul>
					</div>
					<div class="rr5h">
						<dl><dt>备注：</dt><dd><p><?php echo ($ret["verify_bei"]); ?></p><dd></dl>
					</div>
				</div>
			</div>
		</div>
