...
<!--banner-->
<!--content-->
<div style="width: 40%;margin: auto;padding-bottom: 100px">
   <!-- <div style="margin-top: -25px">
        <center><strong><font style="font-size: 22px;"><?php echo ($ret["title"]); ?></font></strong></center>
    </div>-->
    <div style="font-size: 18px;margin-top: 20px;color:#999 ">
        <?php echo ($ret["content"]); ?>
    </div>
</div>
<?php if($ret["title"] == 我要运车): ?><script>
    window.location.href="/Front/Order/normal"
</script><?php endif; ?>
<!--content-->
<!--footer-->
