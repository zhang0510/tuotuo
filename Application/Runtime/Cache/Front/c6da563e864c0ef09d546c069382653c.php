...
<div class="order_main container">
  <div class="order_h2"><h2>优惠券</h2></div>
  <div class="order_list">
    <ul>
    <?php if(is_array($cList)): foreach($cList as $k=>$vo): ?><li>
	  <div class="yh0">
	   <div class="yh01"><img src="/Public/Front/images/rr8.png"></div>
	   <div class="yh02">
	   	<p>使用状态：
	   		<?php echo ($vo["msg"]); ?>
	    </p>
		<p>面值：<span><?php echo ($vo['fav_price']/100); ?>元</span></p>
		<p>期限：<?php echo ($vo["fav_startime"]); ?> - <?php echo ($vo["fav_endtime"]); ?></p>
		<p>优惠码：<?php echo ($vo["fav_code"]); ?></p>
	   </div>
	  </div>
