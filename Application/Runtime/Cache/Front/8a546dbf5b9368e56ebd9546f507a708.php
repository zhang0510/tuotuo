...
<div class="dengm2">
 <div class="deng0 container">
   ...
   <div class="deng2e0">
		<div class="rr4">
			<div class="rr41 frake1 frake3 fee3">
			<h2 class="rra2">订单信息</h2>
				<div class="deng2b1">
				<div class="frake4 fee1">
					<p>车型：<?php echo ($info["order_info_brand"]); ?> <?php echo ($info["order_info_type"]); ?></p></div>
					<div class="olist1  fee2"><?php echo ($info["str"]); ?><img class="eq1" src="/Public/Front/images/ee1.png"><?php echo ($info["end"]); ?></div>
				</div>
			</div>
			...
			<h2 class="rra2">支付</h2>
				<div class="deng2b1">
				 <ul class="zff0">
				  <li class="zff1 on" data="Z">支付宝</li>
				  <li class="zff2" data="H">货到付款</li>
				  <li class="zff3" data="W">微信支付</li>
		...
		<div class="ee81 fee4"><button type="button" onclick="queFun();">确认支付</button></div>
   </div>
   <form action="/Front/Order/paynow" method="post" id="formSubmit">
   		<input type="hidden" name="code" value="<?php echo ($info["order_code"]); ?>">
   		<input type="hidden" id="payway" name="payway" value="Z">
   		<input type="hidden" name="fee" value="<?php echo ($info['order_info_zj']/100); ?>">
   </form>
 </div>
</div>
<script>
