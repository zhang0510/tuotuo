...
<!--content-->
  <div class="banner0">
<img src="/Public/Front/images/banner6.jpg">
  </div>
<div class="new_main">
<div class="new_body container">
  ...
  <div class="new2">
  <?php if(is_array($artList)): foreach($artList as $k=>$vo): ?><div class="col-sm-6 col-md-4 nem1">
		 <a href="/Front/News/detail/code/<?php echo ($vo["article_code"]); ?>">
		   <div class="new2a"><img src="<?php echo ((isset($vo["article_img"]) && ($vo["article_img"] !== ""))?($vo["article_img"]):'/Upload/2016-09-04/57cbd2190ad5f.jpg'); ?>"></div>
		 <div class="new4a">
		<h2><?php echo ($vo["titles"]); ?></h2>
		<p><?php echo ($vo["article_time"]); ?></p>
		 </div>
		 <div class="new3aa">
