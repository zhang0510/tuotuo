...
<!--content-->
  <div class="banner0">
<img src="/Public/Front/images/banner7.jpg">
  </div>
<div class="new_main">
<div class="new_body container">
  ...
  <div class="tnew2">
  <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="nm1">
		<a href="/Front/GroupBuy/groupOne/num/<?php echo ($vo["group_star"]); ?>/code/<?php echo ($vo["group_code"]); ?>">
		    <div class="nm2"><img src="<?php echo ($vo["group_url"]); ?>"></div>
		    <div class="nm3">
	    		<p><?php echo ($vo["group_star"]); ?>辆 —— 优惠 : <span>￥<?php echo ($vo['group_scale']/100); ?>元</span></p>
		 	</div>
		 </a>
