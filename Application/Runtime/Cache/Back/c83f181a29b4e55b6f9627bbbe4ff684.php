									...
									<fieldset>
										<div class="l_uit">
											<div class="control-group">
												...
												<div class="dropdown">
													<select class="height46" name="" id="afeo">
														<option value="">请选择类型</option>
														<?php if(is_array($sk)): foreach($sk as $k=>$vo): ?><option value="<?php echo ($k); ?>" <?php if($k == $type): ?>selected<?php endif; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; ?>
													</select>
													</div>
													<div class="v_pb">
												...
												<!-- /controls -->
												<a href="/Back/Worklwt/contAdd"><button class="red btn btn-default5 fr" type="button">添加内容</button></a>
											...
											<script>
												...
												function awdfuns(){
													...
													var dd = $("#afeo").val();
													if(ss !="" && dd !=""){
														window.location.href="/Back/Worklwt/contList/name/"+ss+'/type/'+dd;
													}else if(ss !="" && dd ==""){
														window.location.href="/Back/Worklwt/contList/name/"+ss;
													}else if(ss =="" && dd !=""){
														window.location.href="/Back/Worklwt/contList/type/"+dd;
													}else{
														$.anewAlert('请选择或输入搜索条件');
											  			return false;
													}
												}
											</script>
											<div class="l_table">
												<table>
													...
													<?php if(is_array($list["list"])): foreach($list["list"] as $key=>$vo): ?><tr class="tr2">
														...
														<td class="td_d2">
															<a href="/Back/Worklwt/contAdd/id/<?php echo ($vo["article_id"]); ?>" class="see1">修改</a>
														</td>
