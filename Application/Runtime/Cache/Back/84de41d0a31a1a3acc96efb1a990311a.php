...
<body>
	<div class="errowBox">
    	<img src="/Public/Back/images/succee_lab.png" class="rightPic">
        <img src="/Public/Back/images/sucee.png" class="errowImg">
        <div class="errowCon">
        <input type="hidden" id="timeId" value="<?php echo ($times); ?>"/>
        <input type="hidden" id="urlId" value="<?php echo ($url); ?>"/>
        <span style="font-weight: bold;color:#999;letter-spacing: 5px;font-family:Arial;font-size: 40px;">HAPPY...</span>
